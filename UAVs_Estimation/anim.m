...
orientation= [1 0 0; 0 -1 0; 0 0 -1]*orientation0*[1 0 0; 0 -1 0; 0 0 -1];
...
% Initialisation des propriétés de la figure
  ...
  set(gca, 'UserData', hc,'NextPlot', 'add','Visible', 'on','DataAspectRatio', [1 1 1], ...
	  'Color', 'w','SortMethod', 'childorder','Xlim',[-2 5],'Ylim',[-6 2],'Zlim',[-3 0] );
  ...
  hc(6)=plot3(Croixdr(1,:),Croixdr(2,:),Croixdr(3,:),'b-','Linewidth',3);
